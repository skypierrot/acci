    ...
    <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="flex items-center justify-center w-10 h-10 bg-green-100 hover:bg-green-200 rounded-full border-2 border-green-300 transition-colors cursor-pointer group"
          title={`현재: ${constant === 200000 ? '20만시' : '100만시'} (클릭하여 변경)`}
        >
          <div className="text-xs font-semibold text-green-700 text-center leading-tight">
