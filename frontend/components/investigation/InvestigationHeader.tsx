...
export const InvestigationHeader: React.FC<InvestigationHeaderProps> = ({ 
  ...
  // (중복 방지) 모바일 메뉴 오픈 상태 및 햄버거/X 버튼 완전히 제거
    ...
    <div className="report-header">
      ...
      <div className="hidden md:flex justify-between items-start">
        <div className="flex-1">
          ...
          {/* 조사일자, 조사팀장, 상태를 한 줄에 가로로 정렬 */}
          <div className="flex flex-row items-center gap-6 mt-2 mb-2">
            {/* 조사일자 */}
      ...
      <div className="md:hidden">
        ...
        {/* 모바일 하단 버튼 영역 */}
        <div className="flex flex-row gap-2 no-print justify-center">
          <Link 
            href="/investigation" 
            className="btn btn-secondary btn-sm flex items-center justify-center"
          >
