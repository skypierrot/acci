            ...
            <div className="py-4">
              {navigationItems.map((item, index) => (
                <Link
                  ...
                  href={item.href}
                  onClick={closeMenu}
                  className={`flex items-center px-6 py-4 text-white hover:bg-primary-700 hover:text-white transition-colors border-b border-neutral-100 ${
                    isActivePage(item.href) ? 'bg-primary-700 text-white border-l-4 border-l-primary-300' : ''
                  }`}
                >
