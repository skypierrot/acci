...
exports.defaultInvestigationFormFields = exports.defaultOccurrenceFormFields = exports.reportFormSettings = void 0;
const pg_core_1 = require("drizzle-orm/pg-core");
// 보고서 양식 필드 설정 테이블
exports.reportFormSettings = (0, pg_core_1.pgTable)("report_form_settings", {
    // 설정 ID (기본키)
    id: (0, pg_core_1.varchar)("id", { length: 50 }).primaryKey(),
    // 보고서 유형 (occurrence: 발생보고서, investigation: 조사보고서)
    report_type: (0, pg_core_1.varchar)("report_type", { length: 20 }).notNull(),
    // 필드 이름 (예: accident_id, acci_time 등)
    field_name: (0, pg_core_1.varchar)("field_name", { length: 100 }).notNull(),
    // 필드 표시 여부 (true: 표시, false: 숨김)
    is_visible: (0, pg_core_1.boolean)("is_visible").default(true),
    // 필수 입력 여부 (true: 필수, false: 선택)
    is_required: (0, pg_core_1.boolean)("is_required").default(false),
    // 필드 순서 (정수: 낮을수록 상위에 표시)
    display_order: (0, pg_core_1.integer)("display_order").default(0),
    // 필드 그룹 (예: 기본정보, 사고정보, 재해자정보 등)
    field_group: (0, pg_core_1.varchar)("field_group", { length: 50 }),
    // 필드 표시 이름 (UI에 표시할 레이블)
    display_name: (0, pg_core_1.varchar)("display_name", { length: 100 }),
    // 필드 설명
    description: (0, pg_core_1.text)("description"),
    // 그리드 레이아웃 정보 (x, y: 위치, w, h: 크기)
    grid_layout: (0, pg_core_1.jsonb)("grid_layout").default({ x: 0, y: 0, w: 1, h: 1 }),
    // 레이아웃 템플릿 정보
    layout_template: (0, pg_core_1.varchar)("layout_template", { length: 50 }).default("compact"),
    // 그룹별 열 수 설정
    group_cols: (0, pg_core_1.integer)("group_cols").default(2),
    // 생성 시간
...
exports.defaultOccurrenceFormFields = [
    // -------------------- 조직정보 그룹 --------------------
...
exports.defaultInvestigationFormFields = [
    // 조사정보 그룹
